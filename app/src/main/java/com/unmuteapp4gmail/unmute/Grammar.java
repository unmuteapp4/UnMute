...
public class Grammar extends AppCompatActivity {
    ...
    private GrammarQuestionLibrary mQuestionLibrary = new GrammarQuestionLibrary();
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if(mQuestionNumber>10){
                    Intent intent = new Intent(Grammar.this, EndGrammar.class);
...
//Start of Button Listener for Button3
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Grammar.this,Tests.class);
        startActivity(intent);
