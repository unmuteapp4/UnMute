...
public class Logic extends AppCompatActivity {
    ...
    private LogicQuestionLibrary mQuestionLibrary = new LogicQuestionLibrary();
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if(mQuestionNumber>10){
                    Intent intent = new Intent(Logic.this, EndLogic.class);
...
//Start of Button Listener for Button3
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Logic.this,Tests.class);
        startActivity(intent);
