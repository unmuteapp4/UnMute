...
public class Probability extends AppCompatActivity {
    ...
    private ProbabilityQuestionLibrary mQuestionLibrary = new ProbabilityQuestionLibrary();
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if(mQuestionNumber>10){
                    Intent intent = new Intent(Probability.this, EndProbability.class);
...
//Start of Button Listener for Button3
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Probability.this,Tests.class);
        startActivity(intent);
