...
public class Tenses extends AppCompatActivity {
    ...
    private TensesQuestionLibrary mQuestionLibrary = new TensesQuestionLibrary();
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                if(mQuestionNumber>10){
                    Intent intent = new Intent(Tenses.this, EndTenses.class);
...
//Start of Button Listener for Button3
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Tenses.this,Tests.class);
        startActivity(intent);
